...
public class SchoolNoticeFragment extends BaseFragment {
    ...
    // 更改特定div的css属性
    private final String hideOtherFun = "javascript:function hideOther() {getClass(document,'header')[0].style.display='none';getClass(document,'ban')[0].style.display='none';getClass(document,'nytit')[0].style.display='none';getClass(document,'ny_left')[0].style.display='none';getClass(document,'footer')[0].style.display='none';}";
    ...
    public void initView(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new WebViewClient(){
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                LogHelper.i("SchoolNoticeFragment", "onPageFinished");
                view.loadUrl(getClassFun);
                view.loadUrl(hideOtherFun);
                view.loadUrl("javascript:hideOther();");
            }
        });
        webView.loadUrl(BizHttpConstants.SCHOOL_TZGG_URL);
        // 刷新
