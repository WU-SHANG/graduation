 ...
 * Description:机构一览模块
 */
public class SchoolInstitutionsFragment extends BaseFragment {
    ...
    // 更改特定div的css属性
    private final String hideOtherFun = "javascript:function hideOther() {getClass(document,'header')[0].style.display='none';getClass(document,'ban')[0].style.display='none';getClass(document,'nytit')[0].style.display='none';getClass(document,'footer')[0].style.display='none';}";
    ...
    public void initView(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        webView.loadUrl(BizHttpConstants.SCHOOL_JGYL_URL);
        // 刷新
