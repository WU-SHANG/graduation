...
public class SchoolInstitutionsFragment extends BaseFragment {
    ...
    private static final String TAG = SchoolInstitutionsFragment.class.getSimpleName();
    ...
    private final String hideOtherFun = "javascript:function hideOther() {" +
            ...
            "getClass(document,'w1300')[0].style.display='none';}";
    ...
    public void initView(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new WebViewClient(){
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                ...
                // 断网或者网络连接超时
                LogHelper.i(TAG, "onReceivedError");
