...
public class TextRoundProgress extends View {
    ...
    public TextRoundProgress(Context context, AttributeSet attrs, int defStyle) {
        ...
        // 获取自定义属性和默认值
        roundColor = mTypedArray.getColor(R.styleable.TextRoundProgress_trp_roundColor, Color.GRAY);
        roundWidth = mTypedArray.getDimension(R.styleable.TextRoundProgress_trp_roundWidth, 40);
        progressColor = mTypedArray.getColor(R.styleable.TextRoundProgress_trp_progressColor, Color.RED);
...
//                new int[]{Color.parseColor("#1BCB55"), Color.TRANSPARENT}, null);
